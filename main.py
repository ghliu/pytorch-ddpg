...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='Pendulum-v0', type=str, help='') # TODO
    parser.add_argument('--hidden1', default=400, type=int, help='')
    parser.add_argument('--hidden2', default=300, type=int, help='')
